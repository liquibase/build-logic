...
5. The purpose of `generate-upload-enterprise-3p-fossa-report.yml` workflow is to:
    ...
    a. Upload individual reports to the R2 bucket path: `/enterprise_fossa_report/raw_reports/` in the `liquibase-org-assets` bucket for the team to review the individual reports.
